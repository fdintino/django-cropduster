...
class CropDusterField(GenericRelation):
    ...
    def formfield(self, **kwargs):
        ...
        widget_cls.parent_admin = parent_admin
        widget_cls.request = request
        formfield_cls.parent_admin = parent_admin
        formfield_cls.request = request

        defaults = {
            'widget': widget_cls,
            'form_class': formfield_cls,
        }
...
from .patch import patch_model_admin, patch_model_form
patch_model_form()
patch_model_admin()
