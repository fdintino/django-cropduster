...
from ..forms import BaseInlineFormSet as CropDusterInlineFormSet
from django.forms.models import BaseInlineFormSet
from django.contrib.contenttypes.generic import BaseGenericInlineFormSet

def nested_inline_formset_factory(superclass):

    class NestedInlineFormSet(superclass):
        ...
        def save(self, commit=True):
            ...
            # Sort on position
            default_data = {'position': 0}
            forms.sort(key=lambda f: getattr(f, 'cleaned_data', default_data).get('position', 0))
...
CropDusterNestedInlineFormSet = nested_inline_formset_factory(
